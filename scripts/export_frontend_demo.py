...
SCENES = [
    {
        "id": "intro",
        "title": "MediSlim",
        "headline": "把身体状态，重新放回一条可持续的生活轨道。",
        "summary": "不是先卖产品，而是先把评估、体质、履约和复购，讲成一条完整体验。",
        "narration": "MediSlim，把身体状态，重新放回一条可持续的生活轨道里。",
        "subtitle": "MediSlim，把身体状态重新放回一条可持续的生活轨道里。",
        "hold": 0.9,
    },
    {
        "id": "imbalance",
    ...
    },
    {
        "id": "outro",
        "title": "更轻，也更稳",
        "headline": "从评估到履约，让每一次健康管理都更稳一点。",
        "summary": "真正可持续的，不是一次冲动下单，而是被看见、被解释、被接住之后，仍愿意继续的健康关系。",
        "narration": "从评估到履约，让每一次健康管理，都更稳一点。MediSlim。",
        "subtitle": "从评估到履约，让每一次健康管理都更稳一点。",
        "hold": 1.2,
    },
]
